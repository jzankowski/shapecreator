...
const App: React.FC = () => {
  // State management
  const [borderRadiusIndex, setBorderRadiusIndex] = useState(1); // Start with borderRadiusMedium (4px)
  const [paddingIndex, setPaddingIndex] = useState(2); // Start with spacingHorizontalM (8px)
  const [childPaddingIndex, setChildPaddingIndex] = useState(1); // Start with spacingHorizontalXXS (2px) for child
  const [outerPaddingIndex, setOuterPaddingIndex] = useState(4); // Start with spacingM (12px) for outer
  const [size, setSize] = useState(40); // Default size of 40px
      ...
      <div style={{ 
        ...
        <div style={{ 
          ...
          <Field 
            label={
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '8px' }}>
                <span style={{ flex: '0 1 auto', minWidth: '0' }}>Size</span>
                <div style={{
                  padding: '4px 8px',
                  backgroundColor: tokens.colorNeutralBackground5,
                  borderRadius: '4px',
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              {activeTab === 'primitives' ? (
                ...
                <Tooltip content="Level 4 - Outer Container" relationship="label">
                  <div style={{
                    ...
                    {/* Level 3 Container */}
                    <Tooltip content="Level 3 - Parent Container" relationship="label">
                      <div style={{
                        ...radiusController.getInputContainerStyle(),
                        width: '100%'
                      }}>
                        {/* Child Container - Tag Style */}
                        <Tooltip content="Level 2 - Child Container (Atom)" relationship="label">
                          <div style={{
                            ...
                            <Tooltip content="Level 1 - Inner Container" relationship="label">
          ...
          {/* Zoom Control at Bottom - Only show for primitives tab */}
          {activeTab === 'primitives' && (
            <div style={{
              flexShrink: 0,
